...
from cert_schema.jsonld_helpers import BLOCKCERTS_V3_BETA_CANONICAL_CONTEXT, BLOCKCERTS_V3_BETA_CONTEXT, \
    BLOCKCERTS_V3_BETA_SCHEMA,BLOCKCERTS_V3_ALPHA_CANONICAL_CONTEXT, BLOCKCERTS_V3_ALPHA_CONTEXT, \
