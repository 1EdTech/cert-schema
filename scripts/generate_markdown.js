...
var schemas = ['../cert_schema/1.2/assertion-1.2.json',
				'../cert_schema/1.2/blockchain-certificate-1.2.json',
				'../cert_schema/1.2/blockchain-receipt-1.2.json',
				'../cert_schema/1.2/certificate-1.2.json',
				'../cert_schema/1.2/certificate-document-1.2.json',
				'../cert_schema/1.2/issuer-1.2.json',
				'../cert_schema/1.2/issuer-id-1.2.json'];
